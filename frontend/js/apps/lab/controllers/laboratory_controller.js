define(function(require) {
    ...
    app.controller("laboratory_controller", ['settingService', '$compile', '$scope', function(settingService, $compile, $scope) {
        var _self = this;
...
*/  
    ...
    app.directive('abc', function(radarFactory) {
        return {
            restrict: "A",
            link: function(scope, element, attr) {
             //   scope.aa = "B"
            },
            template: "<div cde></div>"
        }
    })


    app.directive('cde', function(radarFactory) {
        return {
            restrict: "A",
            scope:{},
            link: function(scope, element, attr) {
